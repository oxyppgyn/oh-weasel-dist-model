...
```{r}
#Files
working_dir <- 'C:\\path\\to\\ASM'
PA_obs_path <- 'C:\\path\\to\\ASM\\PA_obs.csv'
PA_locs_path <- 'C:\\path\\to\\ASM\\PA_locs.csv'
PO_path <- 'C:\\path\\to\\ASM\\PO.csv'
shp_path <- 'C:\\path\\to\\ASM\\state_buffer.shp'
covar_paths <- list(
  'Eastness' = 'C:\\path\\to\\ASM\\eastness.tif',
  'Northness' = 'C:\\path\\to\\ASM\\\\northness.tif'
)
